...
import ar.edu.ejempoci.config.audit.AuditEventConverter;
import ar.edu.ejempoci.domain.PersistentAuditEvent;
...
import static ar.edu.ejempoci.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
